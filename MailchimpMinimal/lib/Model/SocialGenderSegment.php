...
/**
 * SocialGenderSegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SocialGenderSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SocialGenderSegment';
    ...
    const CONDITION_TYPE_SOCIAL_GENDER = 'SocialGender';
    const FIELD_SOCIAL_GENDER = 'social_gender';
    const OP_IS = 'is';
    const OP_NOT = 'not';
    ...
    {
        return [
            self::CONDITION_TYPE_SOCIAL_GENDER,
        ];
    }
     ...
     * Sets field
     *
     * @param string $field Used for segmenting members based on listed gender in Social Profiles data.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string $value The Social Profiles gender to segment.
     *
     * @return $this
     */
