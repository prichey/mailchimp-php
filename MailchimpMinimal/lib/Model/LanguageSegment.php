...
/**
 * LanguageSegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class LanguageSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'LanguageSegment';
    ...
    const CONDITION_TYPE_LANGUAGE = 'Language';
     ...
     * Sets field
     *
     * @param string $field Segmenting based off of a subscriber's language.
     *
     * @return $this
     */
     ...
     * Sets op
     *
     * @param string $op Whether the member's language is or is not set to a specific language.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string $value A two-letter language identifier.
     *
     * @return $this
     */
