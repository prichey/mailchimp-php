 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class VIPSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'VIPSegment';
    ...
    const CONDITION_TYPE_VIP = 'VIP';
    const FIELD_GMONKEY = 'gmonkey';
     ...
     * Sets field
     *
     * @param string $field Segmenting based off of a subscriber's VIP status.
     *
     * @return $this
     */
     ...
     * Sets op
     *
     * @param string $op Whether the member is or is not marked as VIP.
     *
     * @return $this
     */
