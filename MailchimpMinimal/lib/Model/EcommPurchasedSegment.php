...
/**
 * EcommPurchasedSegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EcommPurchasedSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EcommPurchasedSegment';
    ...
    const CONDITION_TYPE_ECOMM_PURCHASED = 'EcommPurchased';
    const FIELD_ECOMM_PURCHASED = 'ecomm_purchased';
    ...
    {
        return [
            self::CONDITION_TYPE_ECOMM_PURCHASED,
        ];
    }
     ...
     * Sets field
     *
     * @param string $field Used for segmenting members who have/have not purchased anything.
     *
     * @return $this
     */
     ...
     * Sets op
     *
     * @param string $op Members who have have ('member') or have not ('notmember') purchased.
     *
     * @return $this
     */
