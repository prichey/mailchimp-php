...
/**
 * BirthdayMergeSegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class BirthdayMergeSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'BirthdayMergeSegment';
    ...
    const CONDITION_TYPE_BIRTHDAY_MERGE = 'BirthdayMerge';
    const OP_IS = 'is';
    const OP_NOT = 'not';
    ...
    {
        return [
            self::CONDITION_TYPE_BIRTHDAY_MERGE,
        ];
    }
     ...
     * Sets field
     *
     * @param string $field A date merge field to segment.
     *
     * @return $this
     */
     ...
     * Sets op
     *
     * @param string $op Whether the member's birthday merge information is/is not a certain date or is/is not blank.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string $value A date to segment against (mm/dd).
     *
     * @return $this
     */
