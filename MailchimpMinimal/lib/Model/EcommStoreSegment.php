...
/**
 * EcommStoreSegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EcommStoreSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EcommStoreSegment';
    ...
    const CONDITION_TYPE_ECOMM_STORE = 'EcommStore';
    const FIELD_ECOMM_STORE = 'ecomm_store';
    const OP_IS = 'is';
    const OP_NOT = 'not';
    ...
    {
        return [
            self::CONDITION_TYPE_ECOMM_STORE,
        ];
    }
     ...
     * Sets field
     *
     * @param string $field Used for segmenting members have purchased from a specific store.
     *
     * @return $this
     */
     ...
     * Sets op
     *
     * @param string $op Members who have or have not purchased from a specific store.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string $value The store id to segment against.
     *
     * @return $this
     */
