...
/**
 * GeoInSegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GeoInSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GeoInSegment';
    ...
    const CONDITION_TYPE_IP_GEO_IN = 'IPGeoIn';
    const FIELD_IPGEO = 'ipgeo';
    const OP_IPGEOIN = 'ipgeoin';
    const OP_IPGEONOTIN = 'ipgeonotin';
     ...
     * Sets op
     *
     * @param string $op Segment members who are within a specific geographic region.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param int $value The radius of the target location.
     *
     * @return $this
     */
     ...
     * Sets addr
     *
     * @param string $addr The address of the target location.
     *
     * @return $this
     */
     ...
     * Sets lat
     *
     * @param string $lat The latitude of the target location.
     *
     * @return $this
     */
     ...
     * Sets lng
     *
     * @param string $lng The longitude of the target location.
     *
     * @return $this
     */
