...
/**
 * SocialNetworkSegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SocialNetworkSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SocialNetworkSegment';
    ...
    const CONDITION_TYPE_SOCIAL_NETWORK_MEMBER = 'SocialNetworkMember';
    const FIELD_SOCIAL_NETWORK = 'social_network';
    const OP_MEMBER = 'member';
    const OP_NOTMEMBER = 'notmember';
    const VALUE_TWITTER = 'twitter';
    const VALUE_FACEBOOK = 'facebook';
    const VALUE_LINKEDIN = 'linkedin';
    const VALUE_FLICKR = 'flickr';
    const VALUE_FOURSQUARE = 'foursquare';
    const VALUE_LASTFM = 'lastfm';
    const VALUE_MYSPACE = 'myspace';
    const VALUE_QUORA = 'quora';
    const VALUE_VIMEO = 'vimeo';
    const VALUE_YELP = 'yelp';
    const VALUE_YOUTUBE = 'youtube';
    ...
    {
        return [
            self::CONDITION_TYPE_SOCIAL_NETWORK_MEMBER,
        ];
    }
     ...
     * Sets field
     *
     * @param string $field Used for segmenting members based on social network in Social Profiles data.
     *
     * @return $this
     */
     ...
     * Sets op
     *
     * @param string $op Members who are/not on a given social network.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string $value The social network to segment against.
     *
     * @return $this
     */
