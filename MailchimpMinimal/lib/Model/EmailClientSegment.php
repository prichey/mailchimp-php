...
/**
 * EmailClientSegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EmailClientSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EmailClientSegment';
    ...
    const CONDITION_TYPE_EMAIL_CLIENT = 'EmailClient';
    const FIELD_EMAIL_CLIENT = 'email_client';
    const OP_IS = 'client_is';
    const OP_NOT = 'client_not';
    ...
    {
        return [
            self::CONDITION_TYPE_EMAIL_CLIENT,
        ];
    }
     ...
     * Sets value
     *
     * @param string $value The name of the email client.
     *
     * @return $this
     */
