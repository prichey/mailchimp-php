...
/**
 * GoalActivitySegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class GoalActivitySegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'GoalActivitySegment';
    ...
    const CONDITION_TYPE_GOAL_ACTIVITY = 'GoalActivity';
    const FIELD_GOAL = 'goal';
    const OP_IS = 'is';
    const OP_GOAL_NOT = 'goal_not';
    const OP_CONTAINS = 'contains';
    const OP_GOAL_NOTCONTAIN = 'goal_notcontain';
    ...
    {
        return [
            self::CONDITION_TYPE_GOAL_ACTIVITY,
        ];
    }
     ...
     * Sets field
     *
     * @param string $field Segmenting based off of a subscriber's Goal activity.
     *
     * @return $this
     */
     ...
     * Sets op
     *
     * @param string $op Whether the website URL is/not exactly, contains/doesn't contain, starts with/ends with a string.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string $value The URL to check Goal activity against.
     *
     * @return $this
     */
