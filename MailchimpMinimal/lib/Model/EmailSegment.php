...
class EmailSegment implements ModelInterface, ArrayAccess
{
    ...
    const CONDITION_TYPE_EMAIL_ADDRESS = 'EmailAddress';
    const FIELD_MERGE0 = 'merge0';
    ...
    {
        return [
            self::CONDITION_TYPE_EMAIL_ADDRESS,
        ];
    }
     ...
     * Sets field
     *
     * @param string $field Segmenting based off of a subscriber's email address.
     *
     * @return $this
     */
     ...
     * Sets op
     *
     * @param string $op Whether the email address is/not exactly, contains/doesn't contain, starts/ends with a string.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string $value The value to compare the email against.
     *
     * @return $this
     */
