...
/**
 * EcommNumberSegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EcommNumberSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EcommNumberSegment';
    ...
    const CONDITION_TYPE_ECOMM_NUMBER = 'EcommNumber';
    const FIELD_SPENT_AVG = 'ecomm_spent_avg';
    const FIELD_ORDERS = 'ecomm_orders';
    const FIELD_PROD_ALL = 'ecomm_prod_all';
    const FIELD_AVG_ORD = 'ecomm_avg_ord';
    const OP_IS = 'is';
    const OP_NOT = 'not';
    ...
    {
        return [
            self::CONDITION_TYPE_ECOMM_NUMBER,
        ];
    }
     ...
     * Sets field
     *
     * @param string $field Used for segmenting members have an average spent total, a total number of orders, total number of products purchased, or average number of products per order.
     *
     * @return $this
     */
     ...
     * Sets op
     *
     * @param string $op Members who have spent exactly, have not spent exactly, spent more, or spent less than the segment value.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param float $value Members who have spent exactly, have not spent exactly, spent more, or spent less than this amount.
     *
     * @return $this
     */
