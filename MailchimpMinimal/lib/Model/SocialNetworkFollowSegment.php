...
/**
 * SocialNetworkFollowSegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SocialNetworkFollowSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SocialNetworkFollowSegment';
    ...
    const CONDITION_TYPE_SOCIAL_NETWORK_FOLLOW = 'SocialNetworkFollow';
    const FIELD_SOCIAL_NETWORK = 'social_network';
    const OP_FOLLOW = 'follow';
    const OP_NOTFOLLOW = 'notfollow';
    const VALUE_TWITTER_FOLLOW = 'twitter_follow';
    ...
    {
        return [
            self::CONDITION_TYPE_SOCIAL_NETWORK_FOLLOW,
        ];
    }
     ...
     * Sets op
     *
     * @param string $op Members who are/not following a linked account on a given social network.
     *
     * @return $this
     */
