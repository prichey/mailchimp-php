...
/**
 * CampaignPollSegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class CampaignPollSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'CampaignPollSegment';
    ...
    const CONDITION_TYPE_CAMPAIGN_POLL = 'CampaignPoll';
    const FIELD_POLL = 'poll';
    ...
    {
        return [
            self::CONDITION_TYPE_CAMPAIGN_POLL,
        ];
    }
     ...
     * Sets op
     *
     * @param string $op Members have/have not interacted with a specific poll in a Mailchimp email.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param float $value The id for the poll.
     *
     * @return $this
     */
