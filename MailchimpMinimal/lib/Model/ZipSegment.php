 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ZipSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ZipSegment';
    ...
    const CONDITION_TYPE_IP_GEO_ZIP = 'IPGeoZip';
    const FIELD_IPGEO = 'ipgeo';
    const OP_IPGEOISZIP = 'ipgeoiszip';
    const OP_IPGEONOTZIP = 'ipgeonotzip';
    ...
    {
        return [
            self::CONDITION_TYPE_IP_GEO_ZIP,
        ];
    }
     ...
     * Sets op
     *
     * @param string $op Segment members who are/are not within a specific US zip code.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param int $value The 5-digit zip code.
     *
     * @return $this
     */
