...
/**
 * DateMergeSegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class DateMergeSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'DateMergeSegment';
    ...
    const CONDITION_TYPE_DATE_MERGE = 'DateMerge';
    const OP_IS = 'is';
    const OP_NOT = 'not';
    const OP_LESS = 'less';
    ...
    {
        return [
            self::CONDITION_TYPE_DATE_MERGE,
        ];
    }
     ...
     * Sets op
     *
     * @param string $op Whether the member's merge information is/is not, is greater/less than a value or is/is not blank.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string $value A date to segment against.
     *
     * @return $this
     */
