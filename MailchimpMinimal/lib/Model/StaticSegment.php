...
/**
 * StaticSegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class StaticSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'StaticSegment';
    ...
    const CONDITION_TYPE_STATIC_SEGMENT = 'StaticSegment';
    const FIELD_STATIC_SEGMENT = 'static_segment';
    const OP_IS = 'static_is';
    const OP_NOT = 'static_not';
    ...
    {
        return [
            self::CONDITION_TYPE_STATIC_SEGMENT,
        ];
    }
     ...
     * Sets op
     *
     * @param string $op Members who are/are not apart of a static segment.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param float $value The id for the static segment.
     *
     * @return $this
     */
