...
/**
 * ConversationSegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ConversationSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ConversationSegment';
    ...
    const CONDITION_TYPE_CONVERSATION = 'Conversation';
    ...
    {
        return [
            self::CONDITION_TYPE_CONVERSATION,
        ];
    }
     ...
     * Sets field
     *
     * @param string $field Used for segmenting subscribers who have/have not interacted with a campaign via 'Converstaions'.
     *
     * @return $this
     */
     ...
     * Sets op
     *
     * @param string $op The status of a member's interaction with a conversation. One of the following: has replied or has not replied.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string $value The web id value for a specific campaign or 'any' to account for subscribers who have/have not interacted with any campaigns.
     *
     * @return $this
     */
