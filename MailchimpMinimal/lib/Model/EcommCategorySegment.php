...
/**
 * EcommCategorySegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EcommCategorySegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EcommCategorySegment';
    ...
    const CONDITION_TYPE_ECOMM_CATEGORY = 'EcommCategory';
    const FIELD_CAT = 'ecomm_cat';
    const FIELD_PROD = 'ecomm_prod';
    const OP_IS = 'is';
    const OP_NOT = 'not';
    const OP_CONTAINS = 'contains';
    const OP_NOTCONTAIN = 'notcontain';
    ...
    {
        return [
            self::CONDITION_TYPE_ECOMM_CATEGORY,
        ];
    }
     ...
     * Sets field
     *
     * @param string $field Used for segmenting subscribers who have/have not purchased specific items or categories.
     *
     * @return $this
     */
     ...
     * Sets op
     *
     * @param string $op A member who has purchased from a category/specific item that is/is not a specific name, where the category/item name contains/doesn't contain a specific phrase or string, or a category/item name that starts/ends with a string.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string $value The ecommerce category/item information.
     *
     * @return $this
     */
