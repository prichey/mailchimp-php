...
/**
 * APIHealthStatus Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class APIHealthStatus implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'API health status';
     ...
     * Sets health_status
     *
     * @param string $health_status This will return a constant string value if the request is successful. Ex. \"Everything's Chimpy!\"
     *
     * @return $this
     */
