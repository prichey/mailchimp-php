...
/**
 * FuzzySegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class FuzzySegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'FuzzySegment';
    ...
    const CONDITION_TYPE_FUZZY_SEGMENT = 'FuzzySegment';
    const FIELD_FUZZY_SEGMENT = 'fuzzy_segment';
    const OP_IS = 'fuzzy_is';
    const OP_NOT = 'fuzzy_not';
    ...
    {
        return [
            self::CONDITION_TYPE_FUZZY_SEGMENT,
        ];
    }
     ...
     * Sets field
     *
     * @param string $field Used for segmenting by Mandrill activity.
     *
     * @return $this
     */
     ...
     * Sets op
     *
     * @param string $op Members who are/are not apart of a 'similar subscribers' segment.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param float $value The id for the 'similar subscribers' segment.
     *
     * @return $this
     */
