...
/**
 * EcommSpentSegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class EcommSpentSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'EcommSpentSegment';
    ...
    const CONDITION_TYPE_ECOMM_SPENT = 'EcommSpent';
    const FIELD_ONE = 'ecomm_spent_one';
    const FIELD_ALL = 'ecomm_spent_all';
    ...
    {
        return [
            self::CONDITION_TYPE_ECOMM_SPENT,
        ];
    }
     ...
     * Sets field
     *
     * @param string $field Used for segmenting members who have spent a specific amount on a single order or over their lifetime.
     *
     * @return $this
     */
     ...
     * Sets op
     *
     * @param string $op Members who have spent 'more' or 'less' than then specified value.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param int $value The total amount a member spent.
     *
     * @return $this
     */
