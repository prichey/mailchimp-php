...
/**
 * AddressMergeSegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AddressMergeSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AddressMergeSegment';
    ...
    const CONDITION_TYPE_ADDRESS_MERGE = 'AddressMerge';
    ...
    {
        return [
            self::CONDITION_TYPE_ADDRESS_MERGE,
        ];
    }
     ...
     * Sets field
     *
     * @param string $field An address-type merge field to segment.
     *
     * @return $this
     */
     ...
     * Sets op
     *
     * @param string $op Whether the member's address merge field contains/does not contain a value or is/is not blank.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string $value The value to segment a text merge field with.
     *
     * @return $this
     */
