...
/**
 * SocialAgeSegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SocialAgeSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SocialAgeSegment';
    ...
    const CONDITION_TYPE_SOCIAL_AGE = 'SocialAge';
    const FIELD_SOCIAL_AGE = 'social_age';
    const OP_IS = 'is';
    const OP_NOT = 'not';
    const VALUE__18_24 = '18-24';
    const VALUE__25_34 = '25-34';
    const VALUE__35_54 = '35-54';
    const VALUE__55 = '55+';
    ...
    {
        return [
            self::CONDITION_TYPE_SOCIAL_AGE,
        ];
    }
     ...
     * Sets field
     *
     * @param string $field Used for segmenting members based age ranges in Social Profiles data.
     *
     * @return $this
     */
     ...
     * Sets op
     *
     * @param string $op Members who are/not the exact criteria listed.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string $value The age range to segment.
     *
     * @return $this
     */
