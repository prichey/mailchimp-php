...
/**
 * MemberRatingSegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class MemberRatingSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'MemberRatingSegment';
    ...
    const CONDITION_TYPE_MEMBER_RATING = 'MemberRating';
    ...
    {
        return [
            self::CONDITION_TYPE_MEMBER_RATING,
        ];
    }
     ...
     * Sets field
     *
     * @param string $field Used for segmenting by member rating.
     *
     * @return $this
     */
     ...
     * Sets op
     *
     * @param string $op Members who have have a rating that is/not exactly a given number or members who have a rating greater/less than a given number.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param float $value The star rating number to segment against.
     *
     * @return $this
     */
