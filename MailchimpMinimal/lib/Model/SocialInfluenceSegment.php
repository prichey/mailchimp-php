...
/**
 * SocialInfluenceSegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SocialInfluenceSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SocialInfluenceSegment';
    ...
    const CONDITION_TYPE_SOCIAL_INFLUENCE = 'SocialInfluence';
    const FIELD_SOCIAL_INFLUENCE = 'social_influence';
    const OP_IS = 'is';
    const OP_NOT = 'not';
    ...
    {
        return [
            self::CONDITION_TYPE_SOCIAL_INFLUENCE,
        ];
    }
     ...
     * Sets field
     *
     * @param string $field Used for segmenting members based on influence rating in Social Profiles data.
     *
     * @return $this
     */
     ...
     * Sets op
     *
     * @param string $op Members who have a rating that is/not or greater/less than the rating provided.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param float $value The Social Profiles influence rating to segment.
     *
     * @return $this
     */
