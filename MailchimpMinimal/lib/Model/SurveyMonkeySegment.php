...
/**
 * SurveyMonkeySegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SurveyMonkeySegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'SurveyMonkeySegment';
    ...
    const CONDITION_TYPE_SURVEY_MONKEY = 'SurveyMonkey';
    const FIELD_SURVEY_MONKEY = 'survey_monkey';
    ...
    {
        return [
            self::CONDITION_TYPE_SURVEY_MONKEY,
        ];
    }
     ...
     * Sets field
     *
     * @param string $field Used for segmenting subscribers who have/have not interacted with a survey monkey survey.
     *
     * @return $this
     */
     ...
     * Sets op
     *
     * @param string $op The status of the member with regard to the survey.One of the following: has started the survey, has completed the survey, has not started the survey, or has not completed the survey.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string $value The unique ID of the survey monkey survey.
     *
     * @return $this
     */
