...
/**
 * IpGeoInZipSegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class IpGeoInZipSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'IpGeoInZipSegment';
    ...
    const CONDITION_TYPE_IP_GEO_IN_ZIP = 'IPGeoInZip';
    const FIELD_IPGEO = 'ipgeo';
    const OP_IPGEOINZIP = 'ipgeoinzip';
    ...
    {
        return [
            self::CONDITION_TYPE_IP_GEO_IN_ZIP,
        ];
    }
     ...
     * Sets op
     *
     * @param string $op Segment members who are within a specific US zip code.
     *
     * @return $this
     */
     ...
     * Sets extra
     *
     * @param int $extra The zip code to segment against.
     *
     * @return $this
     */
