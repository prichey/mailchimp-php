...
/**
 * AutomationSegment Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AutomationSegment implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AutomationSegment';
    ...
    const CONDITION_TYPE_AUTOMATION = 'Automation';
    const FIELD_AUTOMATION = 'automation';
    const OP_STARTED = 'started';
    const OP_COMPLETED = 'completed';
    const OP_NOT_STARTED = 'not_started';
    const OP_NOT_COMPLETED = 'not_completed';
    ...
    {
        return [
            self::CONDITION_TYPE_AUTOMATION,
        ];
    }
     ...
     * Sets field
     *
     * @param string $field Used for segmenting subscribers who have/have not interacted with an Automation workflow.
     *
     * @return $this
     */
     ...
     * Sets op
     *
     * @param string $op The status of the member with regard to the automation workflow. One of the following: has started the workflow, has completed the workflow, has not started the workflow, or has not completed the workflow.
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string $value The web id for the automation workflow to segment against.
     *
     * @return $this
     */
